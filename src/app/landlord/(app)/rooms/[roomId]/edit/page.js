...
import { updateRoomListing } from "@/domain/landlordProperties/useCases/updateRoomListing";
...
export default function EditRoomListingPage() {
  ...
  async function onSubmit(e) {
    ...
    setError("");
    try {
      await updateRoomListing({ roomId, roomType, roomsAvailable, price, description, imageFile });
