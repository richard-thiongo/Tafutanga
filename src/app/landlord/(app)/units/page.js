...
import { updateUnit } from "@/domain/landlordProperties/useCases/updateUnit";
import { deleteUnit } from "@/domain/landlordProperties/useCases/deleteUnit";
import { usePropertyStore } from "@/domain/landlordProperties/propertyStore";
...
function EditUnitModal({ unit, isOpen, onClose, onUpdate, isSubmitting }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto rounded-[2.5rem] border border-border bg-card p-8 shadow-2xl animate-in zoom-in-95 duration-200 scrollbar-hide">
